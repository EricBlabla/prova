...
/**
 * Renombra la variable valor a resultat Encapsula en mètodes estàtics separats
 * del main: El codi que pinta el menu, mètode menu sense paràmetres. Tal i com
 * està al case 3, el mètode dec_oct, crear-ne 2 més per a les conversions del
 * case 1 i al 3.
 *
 * @author Override MMX
 */
